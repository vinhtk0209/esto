...
<form action="" method="POST">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" id="menu"  placeholder="Nhập tên danh mục..." value="{{ $cate->TENDM }}">
        ...
        <div class="form-group">
            ...
            <textarea name="cat-short-des" class="form-control" id="cat-short-des" placeholder="Nhập nội dung...">
                {{$cate->GIOITHIEUDM}}
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="cat-long-des" class="form-control" id="cat-long-des" placeholder="Nhập nội dung...">
               {{ $cate->CHITIETDM }}
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="custom-control custom-radio">
                <input class="custom-control-input" value="1" type="radio" id="active" name="active" {{$cate->ACTIVE==1?'checked':''}}>
                <label for="active" class="custom-control-label">Có</label>
            </div>
            <div class="custom-control custom-radio">
                <input class="custom-control-input" value="0" type="radio" id="no_active" name="active" {{$cate->ACTIVE==0?'checked':''}}>
