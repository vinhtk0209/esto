                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="type" type="radio" id="video" value="0" style="vertical-align:middle; cursor: pointer;" checked>
                                        <label>Video</label><br>
                                        <input name="type" type="radio" id="tructuyen" value="1" style="vertical-align:middle; cursor: pointer;">
