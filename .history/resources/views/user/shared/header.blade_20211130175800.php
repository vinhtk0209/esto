                ...
                <div class="navbar-wrap">
                    <div class="navbar-top">
                                ...
                                <form id="search-form" action="" method="">
                                    <div class="input-group">
                                        ...
                                        <button class="search-button" type="submit">
                                            ...
                                            <img src="{{asset('public/user/assets/img/search-icon.svg')}}" width="20"
                        ...
                        <div class="nav head-direction">
                                ...
                                <div class="k-header-info header-cart">
                                    <div class="cart dropdown">
                                        <a href="" class="dropdown-toggle cart_anchor">
                                            <img src="{{asset('public/user/assets/img/cart.svg')}}" width="24"
                            ...
                            <div class="nav-item">
                                <a href="./signup/signup.html" class="register-btn">Đăng
                                    ký</a>
                                <a href="./login/login.html" class="login-btn">Đăng
                                    nhập</a>
                            </div>
                        </div>
                    </div>
