...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2021 at 06:22 AM
...
(1, 'Ngoại ngữ', 0, 0, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(2, 'Đời sống', 0, 0, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(3, 'Thiết kế đồ họa', 0, 7, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(4, 'Ứng dụng phần mềm', 0, 7, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(5, 'Kỹ năng công việc', 0, 0, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(6, 'Lập trình', 0, 7, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(7, 'Công nghệ thông tin', 0, 0, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(8, 'Tiếng Hàn', 0, 1, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(9, 'Tiếng anh', 0, 1, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(11, 'tiếng trung', 0, 1, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(12, 'tiếng nhật', 0, 1, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(13, 'yoga', 0, 2, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(14, 'ẩm thực ', 0, 2, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(15, 'sức khỏe', 0, 2, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(16, 'nhiếp ảnh', 0, 2, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(17, 'thuyết trình', 0, 5, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(18, 'nâng cao hiệu suất', 0, 5, '2021-12-16 05:02:04', '2021-12-16 12:03:08'),
(34, 'Lập trình Python', 1, 7, '2021-12-16 10:40:03', '2021-12-16 17:40:03');
...
INSERT INTO `taikhoan` (`ID`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `ANHDAIDIEN`, `SODIENTHOAI`, `EMAIL`, `MATKHAU`, `MALOAI`, `TRANGTHAI`, `TOKEN`, `CTCANHAN`, `MACHUNGCHI`, `created_at`, `updated_at`) VALUES
...
(87, 'nguyenquangvinh', '2021-12-17 00:00:00', 1, NULL, '0899305132', 'vinhtk0209@gmail.com', '$2y$10$uUWPIyxpBzAIKh5JPEoakuwGppdvupxWJgxM8m0DoXNPPZK8jbLW2', 1, b'1', NULL, NULL, NULL, '2021-12-14 08:53:40', '2021-12-17 11:55:12');
...
--
ALTER TABLE `baihoc`
  ADD CONSTRAINT `FK_BAIHOC_KHOAHOC1` FOREIGN KEY (`MAKH`) REFERENCES `khoahoc` (`MAKH`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `khuyenmai`
  ADD CONSTRAINT `FK_KHUYENMAI_TTKHUYENMAI` FOREIGN KEY (`MATT`) REFERENCES `ttkhuyenmai` (`MATT`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `taikhoan`
  ADD CONSTRAINT `FK_TAIKHOAN_CHUNGCHI` FOREIGN KEY (`MACHUNGCHI`) REFERENCES `chungchi` (`MACHUNGCHI`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_TAIKHOAN_QUYEN` FOREIGN KEY (`MALOAI`) REFERENCES `loaitk` (`MALOAI`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
